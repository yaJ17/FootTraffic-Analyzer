          ...
          <head>
            ...
            <style>
              ...
              body {
                ...
                line-height: 1.5;
                margin: 0;
                padding: 20px 20px 40px 20px; /* Added padding at bottom for page numbers */
                counter-reset: page;
              }
              .header {
                display: flex;
              ...
              .location-section {
                margin-bottom: 30px;
                page-break-inside: avoid; /* Keep location sections together */
              }
              .page-break {
          ...
          <body>
            ...
            ${filteredReports.map((report, index, array) => `
              <div class="location-section">
                ...
                ${index < array.length - 1 ? '<div class="page-break"></div>' : ''}
              </div>
            `).join('')}
