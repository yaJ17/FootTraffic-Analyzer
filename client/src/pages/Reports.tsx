  ...
  const handleExport = async () => {
    ...
    try {
      if (exportFormat === 'pdf') {
        ...
        // Create CSV content
        let content = 'Location,Population,Avg Foot Traffic,Total Foot Traffic,Avg Dwell Time,Total Dwell Time\n';
      ...
      toast({
        title: "Export Failed",
        description: `Failed to generate ${exportFormat.toUpperCase()} report. Please try again.`,
        variant: "destructive",
      });
    }
  };
